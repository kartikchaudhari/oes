<%@ Page Language="C#" Title="Profile" AutoEventWireup="true" MasterPageFile="~/faculty/FrameContentMaster.Master" CodeBehind="Profile.aspx.cs" Inherits="oes.faculty.Profile" %>
                                ...
                                <table class="table table-striped" border="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:Label ID="lblAccountStatus" runat="server" Font-Bold="true"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
