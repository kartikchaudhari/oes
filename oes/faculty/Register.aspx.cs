      ...
      /***************************************************************************************/
        ...
        protected void submit_btn_Click(object sender, EventArgs e)
        {
            using (db.DbConnect())
            {
                ...
                {
                    SqlCommand FactRegCmd = new SqlCommand("INSERT INTO faculty(first_name,last_name,username,password,email,contact_no,dept_id,account_status) VALUES('" + fname.Text + "','" + lname.Text + "','" + uname.Text + "','" + pass.Text + "','" + email.Text + "','" + contactno.Text + "','" + dept_ddl.SelectedValue + "',0)", db.DbConnect());
