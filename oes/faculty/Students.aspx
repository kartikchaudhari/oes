<%@ Page Title="" Language="C#" MasterPageFile="~/faculty/FrameContentMaster.Master" AutoEventWireup="true" CodeBehind="Students.aspx.cs" Inherits="oes.faculty.Students" %>
            ...
            <!-- /.panel-heading -->
             <div class="panel-body">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#add" data-toggle="tab">Add Students</a>
                    </li>
                </ul>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" style="text-align:center;">
                                        <%--<asp:Chart ID="FacultyChart" runat="server" Height="275px" Width="306px">
                                            <Titles>
                                                <asp:Title Text="No. of Students per Department" Font="Microsoft Sans Serif, 14.25pt"></asp:Title>
                                            </Titles>
                                            <Series>
                                                <asp:Series ChartArea="StudentsChartArea" Name="FacultyChartSeries" ChartType="Pie" 
