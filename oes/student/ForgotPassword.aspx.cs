...
namespace oes.student
{
    public partial class ForgotPassword : System.Web.UI.Page
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("RecoverStudentPassword", Db.DbConnect()))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@EnrollmentNo", tbEnrollmentNo.Text.ToString().Trim());
                ...
                if (rdr.HasRows)
                {
                    ...
                    DataFund.InnerHtml += "<tr class='active'><th>Firstname</th><th>Lastname</th><th>Enrollment No.</th><th>Username</th><th>Passsword</th></tr>";
                    while (rdr.Read())
                    {
