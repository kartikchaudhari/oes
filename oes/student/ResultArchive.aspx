...
<!--breadcrumb end-->
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:Button ID="btnRefresh" runat="server" Text="Refresh" CssClass="btnRefresh btn btn-success" OnClick="btnRefresh_Click" />
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            CssClass="table table-bordered table-hover" DataSourceID="ObjectDataSource1"
                             PageSize="8">
                            <Columns>
