<%@ Page Title="Logs" Language="C#" MasterPageFile="~/admin/FrameContentMaster.Master" AutoEventWireup="true" CodeBehind="Logs.aspx.cs" Inherits="oes.admin.Logs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="page_contents" runat="server">
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-custom-pages">
            <i class="fa fa-edit fa-1x"></i>&nbsp;&nbsp;<span>Manage Logs</span>
        </div>
        <!-- /.panel-heading -->
