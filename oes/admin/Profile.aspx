                ...
                <div class="row clearfix">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6" style="text-align: right;">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-primary"  onclick="javascript:location.reload(true);">Refresh</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="panel panel-primary">
                                <div class="panel-heading"><strong>Bionetric Thumb Impression</strong></div>
                                <div class="panel-body" style="text-align:center;">
