<%@ Page Title="Student Profile" Language="C#" MasterPageFile="~/admin/FrameContentMaster.Master" AutoEventWireup="true" CodeBehind="StudentProfile.aspx.cs" Inherits="oes.admin.StudentProfile" %>
        ...
        <div class="row-fluid">
            <ol class="breadcrumb bc-custom">
                ...
                <li class="breadcrumb-item active">
                    <a class="links" href="Students.aspx">Students</a>
                </li>
                                    ...
                                    <table class="table table-striped" border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><asp:Label ID="LblEnrollmentNo" runat="server"></asp:Label></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><asp:Label ID="LblParentsContact" runat="server"></asp:Label></td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped" border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="right"><strong>Enrollment No. :</strong></td>
                                                <td>
                                                    <asp:TextBox ID="tbEnrollmentNo" runat="server" TextMode="Number" Width="300" Height="27" CssClass="form-control"></asp:TextBox>   
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="right"><strong>Parent's Contact No. :</strong></td>
                                                <td>
                                                    <asp:TextBox ID="tbParentContactNo" runat="server" TextMode="Phone" Width="300" Height="27" CssClass="form-control"></asp:TextBox> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><strong>Department :</strong></td>
                                                <td>
                                                    <asp:DropDownList ID="DdlDept" runat="server" Width="300px"  Height="27px" CssClass="form-control" style="padding:0px;" DataSourceID="DdlDeptDataSource" DataTextField="dept_name" DataValueField="dept_code">
                                                        
                                                    </asp:DropDownList>
                                                    <asp:SqlDataSource ID="DdlDeptDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ExamDbConString %>" SelectCommand="FetchAllDepartment" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><strong>Semeseter :</strong></td>
                                                <td>
                                                    <asp:DropDownList ID="DdlSem" runat="server" Width="300px"  Height="27px" CssClass="form-control" style="padding:0px;" DataSourceID="DdlDeptDataSource" DataTextField="dept_name" DataValueField="dept_code">
